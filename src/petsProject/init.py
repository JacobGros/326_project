...
dogs = [1,10,11,12,2,4,32,33,34,35,55,56,57,58,122,123,124,125,126,127,128,129,130,131,]
...
sm_mam = [3,6,25,29,63,64,65,66,67,69,138,139,]
bugs = [7,19,20,54,59,60,61,62,88,89,90,91,92,93,94,95,]
reptile = [8,18,26,31,36,37,38,39,132,133,134,135,136,137,]
rock = [9,22,23,24,]
